---
title: "CL Match day 1 Season 2627"
...
###############
#set away
Match_Away <- paste0("Atletico")

#Set Home
Match_Home <- paste0("Liverpool")

#set match date
Game_date <- paste("09-09-2026")
...
#set database
DataBaseName <- paste0("CL_LFC_Games_2627")
...
#set home text color
Color_Home_Text <- paste("#FFFFFF")

#set Away color
Color_Away <- paste("black")

#set Away text
Color_Away_Text <- paste("yellow")
...
#load match data
fileName <- paste0("~/Documents/Dropbox files/AI LFC data/Data Sets/WhoScored/Season 2627/CL Games/Processed Games/", Match_Fixture, ".xlsx")
plottingData <- read_xlsx(fileName)

#load player data
PlayerfileName <- paste0("~/Documents/Dropbox files/AI lfc data/Data Sets/WhoScored/Season 2627/CL Players/Processed Games/", Match_Fixture, " - PlayerData.xlsx")
...
#################################
#set color palletes
HomeplottingData <- plottingData %>% filter(TeamName == Match_Home)
AwayplottingData <- plottingData %>% filter(TeamName == Match_Away)
...
#geometrics
  ...
  # smoothed lines
  geom_smooth(data = EPVdfHome, aes(x = expandedMinute, y = EPV_roll5), linewidth = 0.5, color = Color_Home, fill = "snow") +
...
#formatting
  ...
  theme(plot.title = element_text(colour = "black", face = "bold", size = 12),
        ...
        axis.text = element_text(colour = "black", size = 6),
        axis.title = element_text(colour = "black", size = 6, face = "bold"),
        axis = element_rect(colour = "black"),
        plot.margin  = margin(28, 20, 28, 20),
...
AwayEPVTimePlot <- AwayEPVPlotData %>%
  ...
  # smoothed lines
  geom_smooth(data = EPVdfAway, aes(x = expandedMinute, y = EPV_roll5), linewidth = 0.5, color = Color_Away, fill = "snow") +
...
HomeEPVConversionPlot <- EPVPlotData %>%
  ...
  # smoothed lines
  geom_smooth(data = EPVdfHome, aes(x = expandedMinute, y = EPV_Conversion_roll5), linewidth = 0.5, color = Color_Home, fill = "snow") +
...
AwayEPVConversionPlot <- AwayEPVPlotData %>%
  ...
  # smoothed lines
  geom_smooth(data = EPVdfAway, aes(x = expandedMinute, y = EPV_Conversion_roll5), linewidth = 0.5, color = Color_Away, fill = "snow") +
...
### Home {.tabset}
```{r}
#| label: Home Threat plot FT
#| title: Home Threat plot FT
#| fig-width: 4
#| fig-height: 3.6
#| fig-dpi: 200
#| height: 100%
EPVHeatMapplotFT <- EPVHeatMapDataFT %>%
  ...
  geom_text(data = average_epvNZFT, aes(x = x, y = y, label = paste(PEPV, "%")), size = 2) +
  ...
  #formatting
  labs(title = paste0(Match_Home," Open Play EPV Heat Map - FT"), 
...
EPVHeatMapplot1H <- EPVHeatMapData1H %>%
  ...
  # add zone percentage numbers
  geom_text(data = average_epvNZ1H, aes(x = x, y = y, label = paste(PEPV, "%")), size = 2) +
...
EPVHeatMapplot2H <- EPVHeatMapData2H %>%
  ...
  # add zone percentage numbers
  geom_text(data = average_epvNZ2H, aes(x = x, y = y, label = paste(PEPV, "%")), size = 2) +
  ...
  #formatting
  labs(title = paste0(Match_Home," Open Play EPV Heat Map - 2nd Half"), 
                     subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV \nDirection of Attack Left to Right"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
### Away {.tabset}
```{r}
#| label: Away Threat plot FT
#| title: Away Threat plot FT
#| fig-width: 4
#| fig-height: 3.6
#| fig-dpi: 200
#| height: 100%
AwayEPVHeatMapplotFT <- AwayEPVHeatMapDataFT %>%
  ...
  # add zone percentage numbers
  geom_text(data = Awayaverage_epvNZFT, aes(x = x, y = y, label = paste(PEPV, "%")), size = 2) +
  ...
  #formatting
  labs(title = paste(Match_Away," Open Play EPV Heat Map - FT"), 
                            subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV \nDirection of Attack Left to Right"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
AwayEPVHeatMapplot1H <- AwayEPVHeatMapData1H %>%
  ...
  # add zone percentage numbers
  geom_text(data = Awayaverage_epvNZ1H, aes(x = x, y = y, label = paste(PEPV, "%")), size = 2) +
  ...
  #formatting
  labs(title = paste(Match_Away," Open Play EPV Heat Map - 1st Half"), 
                     subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV \nDirection of Attack Left to Right"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
AwayEPVHeatMapplot2H <- AwayEPVHeatMapData2H %>%
  ...
  # add zone percentage numbers
  geom_text(data = Awayaverage_epvNZ2H, aes(x = x, y = y, label = paste(PEPV, "%")), size = 2) +
...
EPVHeatMapplot1sub <- EPVHeatMapData1sub %>%
  ...
  # add zone percentage numbers
  geom_text(data = average_epvNZ1sub, aes(x = x, y = y, label = paste(PEPV, "%")), size = 2) +
  ...
  #formatting
  labs(title = paste0(Match_Home," Open Play EPV Heat Map - To 1st subs"), 
                     subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV \nDirection of Attack Left to Right"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
```{r}
#| label: Home Threat Post 1st Sub
...
EPVHeatMapplotP1sub <- EPVHeatMapDataP1sub %>%
 ...
 annotate("segment", x = c(17, 33.2, 50, 66.4, 83), xend = c(17, 33.2, 50, 66.4, 83), y = 0, yend = 100, linetype = "longdash", linewidth = 0.3, colour = "#95A5A6") +
  ...
  # add zone percentage numbers
  geom_text(data = average_epvNZP1sub, aes(x = x, y = y, label = paste(PEPV, "%")), size = 2) +
...
AwayEPVHeatMapplot1sub <- AwayEPVHeatMapData1sub %>%
  ...
  # add zone percentage numbers
  geom_text(data = Awayaverage_epvNZ1sub, aes(x = x, y = y, label = paste(PEPV, "%")), size = 2) +
  ...
  #formatting
  labs(title = paste(Match_Away," Open Play EPV Heat Map  - To 1st Subs"), 
                     subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV \nDirection of Attack Left to Right"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
```{r}
#| label: Away Threat Post 1st Sub
#| title: Threat Post 1st Sub
#| fig-width: 4
#| fig-height: 3.6
#| fig-dpi: 200
...
AwayEPVHeatMapplotP1sub <- AwayEPVHeatMapDataP1sub %>%
  ...
  # add zone percentage numbers
  geom_text(data = Awayaverage_epvNZP1sub, aes(x = x, y = y, label = paste(PEPV, "%")), size = 2) +
...
DefEPVHeatMapplotFTS <- DefEPVHeatMapDataFTS %>%
  ...
  #formatting
  labs(title = paste0(Match_Home," Successful Defensive EPV Heat Map - FT - Open Play"), 
...
DefEPVHeatMapplotFTU <- DefEPVHeatMapDataFTU %>%
  ...
  #formatting
  labs(title = paste0(Match_Home," Unsuccessful Defensive EPV Heat Map - FT - Open Play"), 
                            subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher Events Faced \nBox figures = % of Total Def EPV, Direction of Attack Right to Left"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
AwayDefEPVHeatMapplotFTS <- AwayDefEPVHeatMapDataFTS %>%
  ...
  #formatting
  labs(title = paste(Match_Away," Successful Defensive EPV Heat Map - FT - Open Play "), 
...
AwayDefEPVHeatMapplotFTU <- AwayDefEPVHeatMapDataFTU %>%
  ...
  #formatting
  labs(title = paste(Match_Away," Unsuccessful Defensive EPV Heat Map - FT - Open Play "), 
                            subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher Events Faced \nBox figures = % of Total EPV, Direction of Attack Right to Left"),
       caption =  My_caption) +
...
PPDAMapplotFT <- ggplot(average_PPDAFT, aes(x = zone_x, y = zone_y, fill = avg_PPDA)) +
  ...
  #formatting
  labs(title = paste0(Match_Home," Open Play Defensive Actions Heat Map - FT"), 
...
HomePPDATimePlot <- HomePPDAPlotData %>%
  ...
  labs(title = paste(Match_Home, " PPDA Development"),
       ...
       caption = My_caption,
       y = "PPDA") +
  theme(plot.title = element_text(colour = "black", face = "bold", size = 8),
        plot.caption = element_markdown(),
        legend.position = "none",
        plot.background = element_rect(colour = "snow", fill = "snow"),
        panel.background = element_rect(colour = "snow", fill = "snow"),
        ...
        axis.title = element_text(colour = "black", size = 6, face = "bold"),
        plot.margin  = margin(28, 20, 28, 20),
        axis.line = element_line(solour = "black")
        ) 
...
HomePPDAHeatMapplot2H <- HomePPDAHeatMapData2H %>%
  ...
  #formatting
  labs(title = paste0(Match_Home," Open Play Defensive Actions Heat Map  - 2nd Half"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher Defensive Actions (DA), \nBox figures = % of Total DA, \nDirection of Attack Right to Left"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
AwayPPDAHeatMapplotFT <- AwayPPDAHeatMapDataFT %>%
  ...
  #formatting
  labs(title = paste(Match_Away," Open Play Defensive Actions Heat Map - FT"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher Defensive Actions (DA), \nBox figures = % of Total DA, \nDirection of Attack Right to Left"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
AwayPPDAHeatMapplot1H <- AwayPPDAHeatMapData1H %>%
  ...
  #formatting
  labs(title = paste(Match_Away," Open Play Defensive Actions Heat Map - 1st Half"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher Defensive Actions (DA), \nBox figures = % of Total DA, \nDirection of Attack Right to Left"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
AwayPPDAHeatMapplot2H <- AwayPPDAHeatMapData2H %>%
  ...
  #formatting
  labs(title = paste(Match_Away," Open Play Defensive Actions Heat Map - 2nd Half"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher Defensive Actions (DA), \nBox figures = % of Total DA, \nDirection of Attack Right to Left"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
HomePPDAHeatMapplot1sub <- HomePPDAHeatMapData1sub %>%
  ...
  #formatting
  labs(title = paste0(Match_Home," Open Play Defensive Actions Heat Map - 1st Subs"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher Defensive Actions (DA), \nBox figures = % of Total DA, \nDirection of Attack Right to Left"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
AwayPPDAHeatMapplot1sub <- AwayPPDAHeatMapData1sub %>%
  ...
  #formatting
  labs(title = paste(Match_Away," Open Play Defensive Actions Heat Map - 1st Subs"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher Defensive Actions (DA), \nBox figures = % of Total DA, \nDirection of Attack Right to Left"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
Post_DA_Action <- Post_DA_Action %>%
  filter(Prev_Defensive_Action == 1) %>%
  mutate(
    Pass_or_Carrie = ifelse(Successful_Passes == 1, 1, 0),

    Prog_Action = ifelse(
      Prog_Passes == 1 | Prog_Carries == 1,
      1,
      0
    ),

    period_displayName = case_when(
      period_displayName == "FirstHalf"  ~ "First Half",
      period_displayName == "SecondHalf" ~ "Second Half",
      TRUE ~ as.character(period_displayName)
    ),
    ...
    Prog_Action = factor(
      Prog_Action,
      levels = c(0, 1),
      labels = c("Successful", "Progressive")
    ),
...
scale_colour_manual(
  ...
  #set scales
  scale_linewidth(range = c(0.5, 2), guide = "none") +
