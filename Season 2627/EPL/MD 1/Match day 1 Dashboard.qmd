...
AwayDefEPVHeatMapplotFTS <- AwayDefEPVHeatMapDataFTS %>%
  ...
  #plot heat map
  #stat_density_2d(aes(fill = after_stat(level)), geom = "polygon", alpha = 0.35, bins = 8, n = 300, adjust = 0.5, linewidth = 0, colour = NA) +
  stat_density_2d(  #data = AwayEvents_FTS_w, 
    aes(x = x, y = y, fill = after_stat(level)), geom = "polygon", alpha = 0.35, bins = 8, n = 300, adjust = 0.5, linewidth = 0, colour = NA) +
