...
TeamPressPlot_OPTA <- function(
  ...
  plot_subtitle <- paste(subtitle,
    ...
    "\nRed fill = Counter Press | Circle = Press Leading to Shot",
    "\nSquare = Direct Possession Win | X = Failed Press | Triangle = Counter Attack",
    "\nDiamond = Group Press | Star = Turnover"
  )
