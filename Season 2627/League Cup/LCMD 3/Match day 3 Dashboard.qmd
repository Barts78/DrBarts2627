---
title: "LC Match day 3 Season 2627"
...
###############
#set away
Match_Away <- paste0("Tottenham")

#Set Home
Match_Home <- paste0("Liverpool")

#set match date
Game_date <- paste("15-09-2026")
...
#set database
DataBaseName <- paste0("LC_LFC_Games_2627")
...
#load match data
fileName <- paste0("~/Documents/Dropbox files/AI LFC data/Data Sets/WhoScored/Season 2627/LC Games/Processed Games/", Match_Fixture, ".xlsx")
plottingData <- read_xlsx(fileName)

#load player data
PlayerfileName <- paste0("~/Documents/Dropbox files/AI lfc data/Data Sets/WhoScored/Season 2627/LC Players/Processed Games/", Match_Fixture, " - PlayerData.xlsx")
